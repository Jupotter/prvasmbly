...
GRAPHICSLIB = -ccopt -L. bigarray.cmxa -I +lablGL lablgl.cmxa lablglut.cmxa -I +sdl sdl.cmxa sdlloader.cmxa -I +lablgtk2 lablgtk.cmxa lablgtkgl.cmxa lablglade.cmxa
...
install.packs:
	${PCKMANAGER} -y reinstall ocaml ocaml-devel ocaml-lablgl ocaml-lablgl-devel ocaml-SDL ocaml-SDL-devel SDL SDL-devel SDL_image ocaml-lablgtk ocaml-lablgtk-devel libglade libglade-devel libglade2-devel gtkglarea2-devel
#END FILE
